...
if(isset($_POST['login'])){
    ...
    $insert = "SELECT * FROM admin_acc WHERE Username = '$id' AND Password = '$pw'";
    ...
    echo header("Location: adminpage.html");
...
<div class="reghere">
	<form method="post">
			<h2>WELCOME BOOKKEEPER!</h2>
		</div>
		<div class="username">
				<label>Book ID:</label>
				&nbsp;&nbsp;
				<input type="text" name="username" id="name"placeholder="Book ID" required>
			<br><br>
			...
			<div class="redirect">
				<a href="Login.php"><label>Login as Regular!</label></a>
			</div><br>
			<div class="redirect2">
				<a href="adminpage.html"><button id="login" name="login">Login</button></a>
			<h5>
